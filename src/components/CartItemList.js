...
const CartItemList = ({ items }) => {
  ...
  return (
    <div className="">
      {items.map((item) => (
        <div
          className="flex justify-between items-start  py-6 px-3 border-b mx-30 border-gray-300 "
        ...
        >
          ...
          <div className="w-38 h-34 ">
            ...
            <div>
              {" "}
              <button
                className="p-2 bg-green-600 font-bold text-[15px] rounded-[10px] px-5 text-white shadow-lg relative bottom-5 ml-3 hover:bg-green-900 transition duration-300 "
